...
<head>
    ...
    <link rel="shortcut icon" href="/img/325da8a36a9b8a9.png">
...
<?php include_once "plantillas/logo.php" ?>
    ...
    <nav class="navegacion">
        <a href="/index.php" class="navegacion__enlace navegacion__enlace--activo" >Tienda</a>
                    ...
                    <a href="/productos.php">
                        <img class="producto__imagen" src="/img/1.jpg" alt="camisa">
                            <div class="producto__informacion">
                                <p class="producto__nombre">Gris T-shirt</p>
